...
func TestConfig_setupAgentsWithDisabledTools(t *testing.T) {
	...
	assert.Equal(t, []string{"agent", "bash", "crush_info", "crush_logs", "multiedit", "fetch", "agentic_fetch", "glob", "ls", "sourcegraph", "todos", "view", "write", "web_search", "diff", "list_mcp_resources", "read_mcp_resource", "memory_search"}, coderAgent.AllowedTools)
...
func TestConfig_setupAgentsWithEveryReadOnlyToolDisabled(t *testing.T) {
	...
	coderAgent, ok := cfg.Agents[AgentCoder]
	require.True(t, ok)
	assert.Equal(t, []string{"agent", "bash", "crush_info", "crush_logs", "download", "edit", "multiedit", "fetch", "agentic_fetch", "todos", "write", "web_search", "diff", "list_mcp_resources", "read_mcp_resource", "memory_search"}, coderAgent.AllowedTools)
